...
export const ALL_SONGS: Song[] = [...iswar_song_details, ...song_details].filter((song, index, self) => !INACTIVE_WEBSITES.some(website => song.website.includes(website)) && index === self.findIndex(s => s.song_url === song.song_url));
...
[
  ...
  },
  {
    ...
    thumbnail: 'https://www.shutterstock.com/image-vector/music-type-playlist-vector-cover-260nw-1757894120.jpg',
    description: 'English Description',
    songs: reveredSong.filter(song => song.language === EnumLanguages.Punjabi),
  },
  {
    id:9,
    name: 'Sambalpuri',
    thumbnail: 'https://www.shutterstock.com/image-vector/music-type-playlist-vector-cover-260nw-1757894120.jpg',
    description: 'English Description',
    songs: reveredSong.filter(song => song.language === EnumLanguages.Sambalpuri),
  },
  
  {
    id:70,
    name: 'Bhajan',
    thumbnail: 'https://mosaic.scdn.co/300/ab67616d00001e024b7f163bb96545539caaf821ab67616d00001e02b9ef8f233ec63b01fb4fab8fab67616d00001e02d22fcff025c3e72fc1cbd394ab67616d00001e02df6de42cf02eefaa296037d7',
    description: 'Bhajan Description',
    songs: reveredSong.filter(song => song.genre === 'Bhajan'),
  },
  { 
    id:99,
